...
\begin{document}
	...
	\begin{figure}[htbp!]
		...
		\subfloat[Βήμα 1 : Εισαγωγή στοιχείων οχήματος αγγελίας]{{\includegraphics[scale=0.45]{img/mockups/post\_lst\_1.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Ανάρτηση πιστοποιητικών εγγράφων κατάστασης και φωτογραφιών]{{\includegraphics[scale=0.45]{img/mockups/post\_lst\_2.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Τιμή Οχήματος]{{\includegraphics[scale=0.45]{img/mockups/post\_lst\_3.png}}}%		
		\qquad
		\subfloat[Βήμα 4 : Εισαγωγή περιγραφής οχήματος, τίτλου αγγελίας και τοποθεσίας πωλητή]{{\includegraphics[scale=0.45]{img/mockups/post\_lst\_4.png}}}%
		\qquad		
		\subfloat[Βήμα 5 : Προεπισκόπηση αγγελίας]{{\includegraphics[scale=0.45]{img/mockups/post\_lst\_5.png}}}%		
	\end{figure}	
	\newpage
