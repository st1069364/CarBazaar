...
\begin{document}
	...
	\begin{itemize}
		...
		\item Μικροαλλαγές στα \en Mockup Screens \gr των \en Use Cases :
			\begin{itemize}
				\item \en"\gr Ανάρτηση Αγγελίας Πώλησης Οχήματος\en"\gr
				\item \en"\gr Σύγκριση Αυτοκινήτων\en"\gr
				\item \en"\gr Αναζήτηση Ανταλλακτικού\en"\gr
				\item \en"\gr Αναζήτηση Οχήματος\en"\gr 
				\item \en"\gr Αγορά Οχήματος\en"\gr 
				\item \en"\gr Ανταλλαγή Οχήματος\en"\gr
				\item \en"\gr Αγορά Ασφαλιστικού Πακέτου\en"\gr 
				\item \en"\gr Αναζήτηση Κοντινών Αντιπροσωπειών\en"\gr
				\item \en"\gr Προγραμματισμός \en Test Drive"\gr
			\end{itemize}		
	\end{itemize}

	Επίσης, άλλαξε το κείμενο της λεζάντας σε κάποια \en mockups\gr. 
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 3 : Εμφάνιση συγκεκριμένου Ανταλλακτικού]{{\includegraphics[scale=0.335]{img/mockups/user/specific\_spare\_part.png}}}%
	\end{figure}
	...
	\begin{figure}[htbp!]
		...
		\subfloat[Βήμα 1 : Εισαγωγή κωδικού αγγελίας] {{\includegraphics[scale=0.475]{img/mockups/user/test\_drive\_1.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Προγραμματισμός Ραντεβού \en Test Drive \gr] {{\includegraphics[scale=0.475]{img/mockups/user/test\_drive\_2.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Επιβεβαίωση στοιχείων \en Test Drive \gr] {{\includegraphics[scale=0.475]{img/mockups/user/test\_drive\_3.png}}}%	
		\qquad	
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 3 : Εισαγωγή Κωδικού Αγγελίας και στοιχεία οχήματος] {{\includegraphics[scale=0.45]{img/mockups/user/car\_insp\_3.png}}}%
		\qquad
		\subfloat[Βήμα 4 : Στοιχεία Ελέγχου \& πληρωμή] {{\includegraphics[scale=0.45]{img/mockups/user/car_insp_4.png}}}%
		\qquad
		\subfloat[Εναλλακτική Ροή 2 : Εισαγωγή στοιχείων επικοινωνίας Ελεγκτή της αρεσκείας του χρήστη] {{\includegraphics[scale=0.45]{img/mockups/user/car\_insp\_alt\_2.png}}}%
		\qquad
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 2 : Εισαγωγή στοιχείων τοποθεσίας, τύπου πωλητή και κριτηρίου ταξινόμησης ]{{\includegraphics[scale=0.476]{img/mockups/user/search\_2.png}}}%			
	\end{figure}
	...
	\begin{figure}[htbp!]
		...
		\qquad					
		\subfloat[Βήμα 4 : Λεπτομέρειες αγγελίας]{{\includegraphics[scale=0.475]{img/mockups/user/search\_4.png}}}%				
	\end{figure}
	...
	\begin{figure}[htbp!]
		\centering			
		\subfloat[Βήμα 1 : Εισαγωγή κωδικών αγγελιών προς σύγκριση]{{\includegraphics[scale=0.42]{img/mockups/user/car\_comp\_1.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Καθορισμός στοιχείων προς σύγκριση, εύρους τιμών και κυρίαρχων κριτηρίων σύγκρισης]{{\includegraphics[scale=0.42]{img/mockups/user/car\_comp\_2.png}}}%		
		\qquad
		\subfloat[Βήμα 3 :  Αποτελέσματα σύγκρισης και επιλογή οχήματος]{{\includegraphics[scale=0.42]{img/mockups/user/car\_comp\_3.png}}}%
		\qquad
		\subfloat[Εναλλακτική Ροή 1 : Σύγκριση αυτοκινήτων από την \en Wishlist \gr και συχνά συγκρινόμενων αυτοκινήτων, λόγω εισαγωγής ίδιων κωδικών αγγελιών]{{\includegraphics[scale=0.42]{img/mockups/user/car\_comp\_alt\_1.png}}}%			
		\qquad			
		\subfloat[Εναλλακτική Ροή 2 : Προειδοποιητικό μήνυμα λόγω μη έγκυρων κωδικών αγγελιών]{{\includegraphics[scale=0.42]{img/mockups/user/car\_comp\_alt\_2.png}}}%			
	\end{figure}
	...
	\begin{figure}[htbp!]
		\centering			
		\subfloat[Βήμα 1 : Εισαγωγή κωδικού ασφαλείας]{{\includegraphics[scale=0.46]{img/mockups/user/buy\_car\_1.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Εισαγωγή κωδικού αγγελίας]{{\includegraphics[scale=0.485]{img/mockups/user/buy\_car\_2.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Οθόνη Διαχείρισης Οικονομικών ]{{\includegraphics[scale=0.49]{img/mockups/user/buy\_car\_3.png}}}%
		\qquad		
		...
		\qquad
		\subfloat[Βήμα 5 : Επιστροφή στην οθόνη Διαχείρισης Οικονομικών και εμφάνιση Τελών Κυκλοφορίας ]{{\includegraphics[scale=0.50]{img/mockups/user/buy_car_5.png}}}%
		\qquad		
		\subfloat[Βήμα 6 : Λεπτομέρειες Αγοράς και ολοκλήρωση αγοράς]{{\includegraphics[scale=0.47]{img/mockups/user/buy\_car\_6.png}}}%			
	\end{figure}
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 2 : Εισαγωγή Λεπτομερειών Ανταλλακτικού] {{\includegraphics[scale=0.45]{img/mockups/user/spare_post_list_2.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Εισαγωγή περιγραφής αγγελίας και εικόνων]{{\includegraphics[scale=0.45]{img/mockups/user/spare_post_list_3.png}}}%
		\qquad
		\subfloat[Βήμα 4 : Προεπισκόπιση αγγελίας] {{\includegraphics[scale=0.45]{img/mockups/user/spare_post_list_4.png}}}%
		\qquad
		\subfloat[Εναλλακτική Ροή 1 : Εμφάνιση προειδοποιητικού μηνύματος λόγω εισαγωγής μη-έγκυρου κωδικού ανταλλακτικού ]{{\includegraphics[scale=0.45]{img/mockups/user/alt_spare_post_list_1.png}}}%			
		\qquad			
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 3 : Τιμή Ασφαλίστρων]{{\includegraphics[scale=0.47]{img/mockups/user/ins_plan_3.png}}}%
		\qquad
