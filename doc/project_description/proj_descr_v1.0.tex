...
\begin{document}
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 2: Επιλογή Μαρκών Οχημάτων]{{\includegraphics[scale=0.43]{img/mockups/user/find\_dealership\_2.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Εμφάνιση λίστας κοντινών αντιπροσωπειών] {{\includegraphics[scale=0.44]{img/mockups/user/dealership_list.png}}}%
		\qquad
		\subfloat[Βήμα 4 : Οθόνη αντιπροσωπείας] {{\includegraphics[scale=0.43]{img/mockups/user/specific_dlrship.png}}}%
	\end{figure}	
	...
	\begin{figure}[htbp!]
		\centering			
		\subfloat[Βήμα 1 : Εισαγωγή κωδικών αγγελιών προς σύγκριση]{{\includegraphics[scale=0.45]{img/mockups/user/car\_comp\_1.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Καθορισμός στοιχείων προς σύγκριση, εύρους τιμών και κυρίαρχων κριτηρίων σύγκρισης]{{\includegraphics[scale=0.45]{img/mockups/user/car\_comp\_2.png}}}%		
		\qquad
		\subfloat[Βήμα 3 :  Αποτελέσματα σύγκρισης και επιλογή οχήματος]{{\includegraphics[scale=0.45]{img/mockups/user/car\_comp\_3.png}}}%
		\qquad
		\subfloat[Εναλλακτική Ροή 1 : Σύγκριση αυτοκινήτων από την \en Wishlist \gr και συχνά συγκρινόμενων αυτοκινήτων, λόγω εισαγωγής ίδιων κωδικών αγγελιών]{{\includegraphics[scale=0.45]{img/mockups/user/car\_comp\_alt\_1.png}}}%			
		\qquad			
		\subfloat[Εναλλακτική Ροή 2 : Προειδοποιητικό μήνυμα λόγω μη έγκυρων κωδικών αγγελιών]{{\includegraphics[scale=0.478]{img/mockups/user/car\_comp\_alt\_2.png}}}%			
	\end{figure}
