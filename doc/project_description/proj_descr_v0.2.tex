...
\begin{document}
	...
	Τέλος, η ασφαλιστική εταιρεία παρέχει \en Live 24/7 Support \gr στους χρήστες, με σκοπό την επίλυση ζητημάτων που μπορούν να προκύψουν κατά την διεξαγωγή συναλλαγών είτε νομικών ζητημάτων. \break
	...
	\begin{figure}[htbp!]
		...
		\subfloat[Βήμα 1 :Τοποθέτηση αριθμού αγγελίας] {{\includegraphics[scale=0.45]{img/mockups/user/test_drive_listcode.png}}}%
		\qquad
		\subfloat[Βήμα 2 :Κλείσιμο Ραντεβού \en Test Drive \gr] {{\includegraphics[scale=0.45]{img/mockups/user/test_drive_appointment.png}}}%
		\qquad
		\subfloat[Βήμα 3 :Μύνημα λάθους επιλογής ημερομηνίας] {{\includegraphics[scale=0.45]{img/mockups/user/tst_drv_error_scrn.png}}}%
	\end{figure}
	...
	\begin{figure}[htbp!]
		...
		\subfloat[Βήμα 1 :Τοποθέτηση τοποθεσίας χρήστη] {{\includegraphics[scale=0.45]{img/mockups/user/dealership_loc.png}}}%
		\qquad
		\subfloat[Βήμα 2 :Λίστα κοντινών αντιπροσωπειών] {{\includegraphics[scale=0.45]{img/mockups/user/dealership_list.png}}}%
		\qquad
	...
	\begin{figure}[htbp!]
		...
		\subfloat[Βήμα 1 :Κλείσιμο ραντεβού ελέγχου οχήματος] {{\includegraphics[scale=0.45]{img/mockups/user/car_check_date.png}}}%
		\qquad
		\subfloat[Βήμα 2 :Επιλογή ελεγκτή] {{\includegraphics[scale=0.45]{img/mockups/user/inspector_choice.png}}}%
		\qquad
		\subfloat[Βήμα 3 :Οργάνωση ραντεβού και πληρωμή] {{\includegraphics[scale=0.45]{img/mockups/user/payment_check.png}}}%
