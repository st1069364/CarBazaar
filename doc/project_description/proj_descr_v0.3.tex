...
\begin{document}
	...
	\begin{itemize}
		...
		\item \en \#8: \gr Ανταλλαγή Οχήματος
	...
	\vspace{10pt}
	\flushleft
	Αφαιρέθηκε η δυνατότητα ανταλλαγής οχημάτων μεταξύ ιδιωτών χρηστών και αντικαταστάθηκε από το \textit{Πρόγραμμα Ανταλλαγής Οχημάτων}, μέσω του οποίου ένας χρήστης μπορεί να παραδώσει ένα όχημά του σε μια αντιπροσωπεία και να επωφεληθεί οικονομικά (η παράγραφος που προστέθηκε, έχει κόκκινο χρώμα).
	...
	\begin{figure}[htbp!]
		...
		\qquad	
		\subfloat[Εναλλακτική Ροή 1: Μύνημα μη-διαθέσιμης ημερομηνίας] {{\includegraphics[scale=0.45]{img/mockups/user/test\_drive\_alt\_1.png}}}%
		\qquad
		\subfloat[Εναλλακτική Ροή 2: Μύνημα μη-έγκυρου κωδικού αγγελίας] {{\includegraphics[scale=0.45]{img/mockups/user/test\_drive\_alt\_2.png}}}%
	\end{figure}
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 2 : Εμφάνιση λίστας κοντινών αντιπροσωπειών] {{\includegraphics[scale=0.45]{img/mockups/user/dealership_list.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Οθόνη συγκεκριμένης αντιπροσωπείας] {{\includegraphics[scale=0.45]{img/mockups/user/specific_dlrship.png}}}%
	\end{figure}	
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 2 : Προτεινόμενος Ελεγκτής] {{\includegraphics[scale=0.45]{img/mockups/user/car\_check\_2.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Λεπτομέρειες ραντεβού και πληρωμή] {{\includegraphics[scale=0.45]{img/mockups/user/car\_check\_3.png}}}%
		
		\subfloat[Εναλλακτική Ροή 2 : Ελεγκτής της αρεσκείας του χρήστη] {{\includegraphics[scale=0.45]{img/mockups/user/car\_check\_alt\_2.png}}}%
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 3 : Οικονομικές Επιλογές ]{{\includegraphics[scale=0.47]{img/mockups/user/buy\_car\_3.png}}}%
		\qquad		
		...
		\qquad
		\subfloat[Βήμα 5 : Λεπτομέρειες Αγοράς]{{\includegraphics[scale=0.45]{img/mockups/user/buy\_car\_5.png}}}%	
	\end{figure}
	...
	\begin{figure}[htbp!]
		\centering			
		\subfloat[Βήμα 1 : Λίστα προυπάρχοντων αγγελιών]{{\includegraphics[scale=0.47]{img/mockups/user/edit_listings.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Επεξεργασία αγγελίας] {{\includegraphics[scale=0.47]{img/mockups/user/submit_changes_lis.png}}}%
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Εναλλακτική Ροή 1 : Εμφάνιση προειδοποιητικού μυνήματος λόγω εισαγωγής λανθασμένου κωδικού ανταλλακτικού ]{{\includegraphics[scale=0.45]{img/mockups/user/alt_spare_post_list_1.png}}}%			
		\qquad			
	...
	\begin{figure}[htbp!]
		...
		{{\includegraphics[scale=0.6]{img/ui\_screens/user_menu.png}}}%
		\qquad
		\subfloat[\en Car check Mockup screen 1 \gr χρησιμοποιώντας \en PyQt] {{\includegraphics[scale=0.68]{img/ui\_screens/car_check1.png}}}%
	\end{figure}
