...
\begin{document}
	...
	Αφαιρέθηκε η δυνατότητα ανταλλαγής οχημάτων μεταξύ ιδιωτών χρηστών και αντικαταστάθηκε από το \textit{Πρόγραμμα Ανταλλαγής Οχημάτων}, μέσω του οποίου ένας χρήστης μπορεί να παραδώσει ένα όχημά του σε μια αντιπροσωπεία και να επωφεληθεί οικονομικά (η παράγραφος που προστέθηκε, έχει κόκκινο χρώμα).
		...
		\vspace{10pt}
		Προστέθηκαν \en screenshots \gr των \en UI screens \gr για το \en Use Case "\gr Ανάρτηση Αγγελίας Πώλησης Οχήματος\en" \gr (όλες πλην της τελευταίας) και των πρώτων δύο οθονών του \en Use Case "\gr Προγραμματισμός Ελέγχου Οχήματος\en"\gr.
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Εναλλακτική Ροή 2: Μήνυμα μη-έγκυρου κωδικού αγγελίας] {{\includegraphics[scale=0.45]{img/mockups/user/test\_drive\_alt\_2.png}}}%
	\end{figure}
