	...
	\newpage
		...
		\centering{ \textbf{Αγορά Οχήματος}}
			...
			\begin{figure}[htbp!]
				...
				\qquad
				\subfloat[Βήμα 3 : Επιλογή αγοράς ασφαλιστικής κάλυψης]{{\includegraphics[scale=0.47]{img/mockups/user/buy\_car\_3.png}}}%
				\qquad
				\subfloat[Συνολική τιμή]{{\includegraphics[scale=0.47]{img/mockups/user/buy\_car\_4.png}}}%				
			\end{figure}
