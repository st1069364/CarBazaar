...
\begin{document}
	...
	\begin{itemize}
		...
		\item \en \red{\#11}: \gr Ανάρτηση Αγγελίας Πώλησης Ανταλλακτικού
		\item \en \red{\#13}: \gr Αγορά Ασφαλιστικού Πακέτου
		\red{\item \en \#11: \gr Επεξεργασία Αγγελίας : Το \en Use Case \gr αφαιρέθηκε λόγω απλότητας και συνεπώς και τα  \en Mockups Screens \gr  που είχαν δημιουργηθεί }
	\end{itemize}
	...
	\begin{figure}[htbp!]
		...
		\qquad
		\subfloat[Βήμα 4 : Τιμή Οχήματος]{{\includegraphics[scale=0.54]{img/mockups/post\_lst\_4.png}}}%
		\qquad
