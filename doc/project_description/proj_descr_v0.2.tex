...
\begin{document}
	...
	\begin{itemize}
		\item Επέκταση της περιγραφής του έργου και ανάλυση των λειτουργιών που παρέχονται σε κάθε είδος χρήστη (οι αλλαγές δεν έχουν σημειωθεί καθώς υπήρξε σημαντική επέκταση του αρχικού κειμένου)
		\item Αντικατάσταση των \en Wireframes \gr με \en Mockup Screens \gr 
		\item Προσθήκη υλοποίησης του \en User Menu Mockup \gr σε πραγματική \en UI \gr οθόνη
	\end{itemize}
	...
	\begin{figure}[htbp!]
		...
		\subfloat[Βήμα 1 : Εισαγωγή αριθμού αγγελίας] {{\includegraphics[scale=0.45]{img/mockups/user/test_drive_listcode.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Προγραμματισμός Ραντεβού \en Test Drive \gr] {{\includegraphics[scale=0.45]{img/mockups/user/test_drive_appointment.png}}}%
		\qquad
		\subfloat[Εναλλακτική Ροή : Μύνημα λανθασμένης επιλογής ημερομηνίας] {{\includegraphics[scale=0.45]{img/mockups/user/tst_drv_error_scrn.png}}}%
	\end{figure}
	...
	\begin{figure}[htbp!]
		...
		\subfloat[Βήμα 1 : Προγραμματισμός ραντεβού ελέγχου οχήματος] {{\includegraphics[scale=0.45]{img/mockups/user/car_check_date.png}}}%
		\qquad
		\subfloat[Βήμα 2 : Επιλογή ελεγκτή] {{\includegraphics[scale=0.45]{img/mockups/user/inspector_choice.png}}}%
		\qquad
		\subfloat[Βήμα 3 : Λεπτομέρειες ραντεβού και πληρωμή] {{\includegraphics[scale=0.45]{img/mockups/user/payment_check.png}}}%
	...
	\newpage
		...
		\begin{figure}[htbp!]
			...
			\qquad
			\subfloat[Εναλλακτική Ροή : Σύγκριση αυτοκινήτων από την \en Wishlist \gr και συχνά συγκρινόμενων αυτοκινήτων]{{\includegraphics[scale=0.45]{img/mockups/user/car\_comp\_alt.png}}}%						
		\end{figure}
		...
		\centering{ \textbf{Αγορά Οχήματος}}
			...
			\begin{figure}[htbp!]
				\centering			
				\subfloat[Βήμα 1 : Εισαγωγή κωδικού ασφαλείας, κωδικού αγγελίας και οικονομικές επιλογές]{{\includegraphics[scale=0.47]{img/mockups/user/buy\_car\_1.png}}}%
				\qquad
				\subfloat[Βήμα 2 : Εισαγωγή Μηνιαίου μισθού και υπολογισμός μηνιαίας δόσης] {{\includegraphics[scale=0.47]{img/mockups/user/buy\_car\_2.png}}}%
				\qquad
				\subfloat[Βήμα 3 : Συνολική Τιμή]{{\includegraphics[scale=0.45]{img/mockups/user/buy\_car\_3.png}}}%	
			\end{figure}
