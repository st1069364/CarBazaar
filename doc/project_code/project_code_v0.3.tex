...
\begin{document}
	...
	\red{Επίσης, υπάρχουν και μέθοδοι που δεν εμφανίζονται στο \en Class Diagram \gr, (πχ \en getters/setters \gr), αλλά υλοποιούνται καθώς (λογικά) θα χρειαζόντουσαν στην πλήρη έκδοση της εφαρμογής.}  \break
