...
\begin{document}
	...
	Τα \en tasks, \gr πχ περισσότερα \en mockup screens\gr,επιλογή επιπλέον προγραμματιστικών εργαλείων,χρονοδιάγραμμα για δοκιμές και ελέγχους λαθών κλπ αποτυπώνονται πάνω στα διαγράμματα \en Gantt \gr και \en Pert \gr μαζί με τις αντίστοιχες ημερομηνίες εφαρμογής τους. \break
	...
	\begin{figure}[htbp!]
		...
		\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{gantt\_chart\_project\_plan.png}
	...
	\begin{figure}[htbp!]
		...
		\includegraphics[width=\textwidth, height=\textheight, keepaspectratio ]{PertChart\_for\_Projectplan.jpg}
