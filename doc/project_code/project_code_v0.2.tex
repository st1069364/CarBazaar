...
\begin{document}
	...
	Στο αρχείο \en \textbf{post\_lst.py} \gr υπάρχει ο κώδικας για τις μεταβάσεις μεταξύ των οθονών του \en Use case \gr \en"\gr Ανάρτηση Αγγελίας Πώλησης Οχήματος\en"\gr.  Συγκεκριμένα, κάνοντας κλικ στο κουμπί \en 'Continue' \gr , γίνεται μετάβαση στην επόμενη οθόνη, και κάνοντας κλικ στο κουμπί \en 'Back' \gr , γίνεται μετάβαση στην προηγούμενη οθόνη.
	...
	Στο αρχείο \en \textbf{src/classes.py} \gr, υπάρχει μια πρώιμη έκδοση των κλάσεων του \en Domain Model\gr, καθώς περιλαμβάνει μόνο τα \en attributes \gr των κλάσεων. \break
