...
\begin{document}
	...
	\begin{itemize}
		...
		\item Προσθήκη του κινδύνου Νο. 10 (Μη-κλιμακούμενη αρχιτεκτονική συστήματος)
		\item Προσθήκη του κινδύνου Νο. 11 (Προβληματική λειτουργία \en Recommender System \gr)
	\end{itemize}
...
\end{figure}
	...
	\begin{figure}[htbp!]
		\includegraphics[scale=0.75]{img/unscalable\_arch.png}
	...
	\begin{figure}[htbp!]
		\includegraphics[scale=0.53]{img/rec_system_underfunction.png}
