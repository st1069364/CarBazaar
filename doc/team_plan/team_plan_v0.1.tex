...
\begin{document}
	...
	\newpage
		...
		\flushleft
		Η ομάδα μας χρησιμοποιώντας την μέθοδο \en SCRUM \gr κατάφερε να επιτύχει τους στόχους που είχε θέσει από την αρχή του \en project \gr και να βγάλει ένα πολυ ικανοποιητικό αποτέλεσμα.
		Όσον αφορά τα πράγματα που θα μπορούσαμε να αλλάξουμε και να διαχειριστούμε διαφορετικά αυτά θα περιελάμβαναν την διοργάνωση περισσότερων \en daily scrum meetings \gr αλλά και άτυπων διοριών ανάμεσα στα παραδοτέα ,με σκοπό την αποτελεσματικότερη οργάνωση των ομάδας.   
\end{document}
